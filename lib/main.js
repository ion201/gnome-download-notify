...
function onDlChange(download){
    ...
    var cd = Cc['@mozilla.org/file/directory_service;1'].getService(Ci.nsIDirectoryServiceProvider).getFile('CurWorkD', {}).path;
    ...
    if (prefs.icon_path)
        ...
        args.push('-i', cd + '/data/icon-16.png');
    ...
    args.push('Download completed ' + download.target.path, '');
